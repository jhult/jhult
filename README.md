...
- [tontinton/maki](https://github.com/tontinton/maki) - An efficient AI coding agent extendable by neovim-like Lua plugins (5 days ago)
...
- [jdx/mise](https://github.com/jdx/mise) ([v2026.9.11](https://github.com/jdx/mise/releases/tag/v2026.9.11), 1 day ago) - dev tools, env vars, task runner
- [aaif-goose/goose](https://github.com/aaif-goose/goose) ([v1.51.0](https://github.com/aaif-goose/goose/releases/tag/v1.51.0), 2 days ago) - an open source, extensible AI agent that goes beyond code suggestions - install, execute, edit, and test with any LLM
- [jsdom/jsdom](https://github.com/jsdom/jsdom) ([v30.1.0](https://github.com/jsdom/jsdom/releases/tag/v30.1.0), 2 days ago) - A JavaScript implementation of various web standards, for use with Node.js
- [aquaproj/aqua-registry](https://github.com/aquaproj/aqua-registry) ([v4.564.0](https://github.com/aquaproj/aqua-registry/releases/tag/v4.564.0), 3 days ago) - aqua&#39;s Standard Registry
- [tontinton/maki](https://github.com/tontinton/maki) ([v0.5.5](https://github.com/tontinton/maki/releases/tag/v0.5.5), 3 days ago) - An efficient AI coding agent extendable by neovim-like Lua plugins
- [gastownhall/beads](https://github.com/gastownhall/beads) ([v1.3.0](https://github.com/gastownhall/beads/releases/tag/v1.3.0), 4 days ago) - Beads - A memory upgrade for your coding agent
- [jdx/hk](https://github.com/jdx/hk) ([v2.0.1](https://github.com/jdx/hk/releases/tag/v2.0.1), 4 days ago) - git hooks and project lints
...
- [Add MIT license](https://github.com/tontinton/makiconf/pull/1) on [tontinton/makiconf](https://github.com/tontinton/makiconf) (2 days ago)
- [Add MIT license](https://github.com/Asaf51/maki-review/pull/2) on [Asaf51/maki-review](https://github.com/Asaf51/maki-review) (2 days ago)
- [Add MIT license](https://github.com/g4bwy/maki-plugins/pull/1) on [g4bwy/maki-plugins](https://github.com/g4bwy/maki-plugins) (2 days ago)
- [feat: add --worktree flag to run maki inside a git worktree](https://github.com/tontinton/maki/pull/1018) on [tontinton/maki](https://github.com/tontinton/maki) (3 days ago)
- [Fix flaky tests and a macOS APFS test fallout](https://github.com/tontinton/maki/pull/1015) on [tontinton/maki](https://github.com/tontinton/maki) (5 days ago)
...
- [feat(instagram): reflect effective toggle state in About patch list](https://github.com/crimera/piko/pull/1835) on [crimera/piko](https://github.com/crimera/piko) (2 weeks ago)
- [feat: treat xapk/apks split-APK containers as APK files](https://github.com/neocanable/garlic/pull/101) on [neocanable/garlic](https://github.com/neocanable/garlic) (2 weeks ago)
- [fix(todo_write): keep the todo panel updated across steps](https://github.com/tontinton/maki/pull/948) on [tontinton/maki](https://github.com/tontinton/maki) (2 weeks ago)

#### ⭐ Recent Stars

- [get-bb/bb](https://github.com/get-bb/bb) - The agent IDE that builds itself (1 day ago)
- [thepowersgang/mrustc](https://github.com/thepowersgang/mrustc) - Alternative rust compiler (re-implementation) (1 day ago)
- [asciimoo/hister](https://github.com/asciimoo/hister) - Your own search engine (2 days ago)
- [g4bwy/maki-plugins](https://github.com/g4bwy/maki-plugins) - various plugins for maki (2 days ago)
- [basvk/maki-browser-plugin](https://github.com/basvk/maki-browser-plugin) - Browser tools for the Make coding agent (2 days ago)
- [athos2113/fillvisa-os](https://github.com/athos2113/fillvisa-os) - Open-source platform for U.S. immigration forms. Fill DS-160 and USCIS forms in-browser, generate ready-to-review PDFs, and self-host anywhere. (4 days ago)
...
- [OpenHFT/Open-Understanding](https://github.com/OpenHFT/Open-Understanding) - From shared understanding to supportable implementation (6 days ago)
- [browser-use/browser-use](https://github.com/browser-use/browser-use) - Agents that use the browser. (6 days ago)
