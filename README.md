...
- [vaadin/flow](https://github.com/vaadin/flow) ([24.5.0.alpha4](https://github.com/vaadin/flow/releases/tag/24.5.0.alpha4), 5 days ago) - Vaadin Flow is a Java framework binding Vaadin web components to Java. This is part of Vaadin 10&#43;.
...
- [feat: beta ribbon](https://github.com/Granola-Team/mina-block-explorer/pull/914) on [Granola-Team/mina-block-explorer](https://github.com/Granola-Team/mina-block-explorer) (today)
- [feat: gracefully shutdown](https://github.com/Granola-Team/mina-indexer/pull/1210) on [Granola-Team/mina-indexer](https://github.com/Granola-Team/mina-indexer) (2 days ago)
...
- [o1-labs/mina-lightweight-explorer](https://github.com/o1-labs/mina-lightweight-explorer) - Lightweight Mina Explorer (today)
- [jdx/mise](https://github.com/jdx/mise) - dev tools, env vars, task runner (1 day ago)
- [fluentci-io/fluentci](https://github.com/fluentci-io/fluentci) - Set up and run your CI locally or in any CI Provider in a consistent way (1 day ago)
- [fluentci-io/fluentci-engine](https://github.com/fluentci-io/fluentci-engine) - Programmable CI/CD engine without Containers, written in Rust, built on top of Wasm and Nix ❄️ (1 day ago)
- [alibaba/git-repo-go](https://github.com/alibaba/git-repo-go) - git-repo is a command-line tool for centralized workflow, can work with Gerrit, AGit-Flow compatible servers. It is written in Golang, and it can be installed easily without further dependency. It provides an easy-to-use solution for multiple repositories which is introduced by Android repo first, and it can also work with a single repository. (5 days ago)
- [unisonweb/unison](https://github.com/unisonweb/unison) - A friendly programming language from the future (5 days ago)
- [mikeroyal/WireGuard-Guide](https://github.com/mikeroyal/WireGuard-Guide) - WireGuard Guide. Learn all  about WireGuard for Networking and in the Cloud (Microsoft Azure, AWS, and Google Cloud). (6 days ago)
- [unikraft/unikraft](https://github.com/unikraft/unikraft) - A next-generation cloud native kernel designed to unlock best-in-class performance, security primitives and efficiency savings. (6 days ago)
- [playwright-community/eslint-plugin-playwright](https://github.com/playwright-community/eslint-plugin-playwright) - ESLint plugin for Playwright (6 days ago)
- [playwright-community/cy2pw](https://github.com/playwright-community/cy2pw) -  (6 days ago)
