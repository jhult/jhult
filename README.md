...
- [vaadin/flow](https://github.com/vaadin/flow) ([24.5.2](https://github.com/vaadin/flow/releases/tag/24.5.2), 3 days ago) - Vaadin Flow is a Java framework binding Vaadin web components to Java. This is part of Vaadin 10&#43;.
...
- [Add MIT license](https://github.com/garethtdavies/mina-payout/pull/1) on [garethtdavies/mina-payout](https://github.com/garethtdavies/mina-payout) (2 days ago)
- [Add MIT license](https://github.com/jrwashburn/mina-addresses/pull/1) on [jrwashburn/mina-addresses](https://github.com/jrwashburn/mina-addresses) (2 days ago)
- [feat(staking): make epoch selectable in header](https://github.com/Granola-Team/mina-block-explorer/pull/1140) on [Granola-Team/mina-block-explorer](https://github.com/Granola-Team/mina-block-explorer) (4 days ago)
- [chore: remove unused mina_rs code (proofs, bin_prot, etc.)](https://github.com/Granola-Team/mina-indexer/pull/1640) on [Granola-Team/mina-indexer](https://github.com/Granola-Team/mina-indexer) (6 days ago)
...
- [lucioreyli/graphql-formatter](https://github.com/lucioreyli/graphql-formatter) - A rust based tool to format GraphQL files. (1 day ago)
- [g-plane/pretty_graphql](https://github.com/g-plane/pretty_graphql) - Configurable GraphQL formatter. (1 day ago)
- [gqlgo/gqlfmt](https://github.com/gqlgo/gqlfmt) - gqlfmt formats your GraphQL files. like gofmt. (1 day ago)
- [garethtdavies/mina-payout](https://github.com/garethtdavies/mina-payout) -  (2 days ago)
- [swagger-api/swagger-editor](https://github.com/swagger-api/swagger-editor) - Swagger Editor (2 days ago)
- [M66B/NetGuard](https://github.com/M66B/NetGuard) - A simple way to block access to the internet per app (3 days ago)
- [TrackerControl/tracker-control-android](https://github.com/TrackerControl/tracker-control-android) - TrackerControl Android: monitor and control trackers and ads. (3 days ago)
- [e2b-dev/desktop](https://github.com/e2b-dev/desktop) - E2B Desktop Sandbox for LLMs. E2B Sandbox with desktop graphical environment that you can connect to any LLM for secure computer use. (3 days ago)
