...
- [lobsters/lobsters](https://github.com/lobsters/lobsters) - Computing-focused community centered around link aggregation and discussion (1 day ago)
- [please-build/java-rules](https://github.com/please-build/java-rules) -  (1 day ago)
- [bazelbuild/buildtools](https://github.com/bazelbuild/buildtools) - A bazel BUILD file formatter and editor (2 days ago)
- [keadex/keadex](https://github.com/keadex/keadex) - Monorepo containing Keadex applications and libraries. (2 days ago)
- [soulspace-org/overarch](https://github.com/soulspace-org/overarch) - Overarch provides a data model for the holistic description of a software system, opening multiple use cases on the model data. Supports C4 and UML diagram generation with PlantUML. (2 days ago)
- [RDBModel/rdbmodel.github.io](https://github.com/RDBModel/rdbmodel.github.io) - Simplified C4 model yaml editor (2 days ago)
- [Schniz/fnm](https://github.com/Schniz/fnm) - 🚀 Fast and simple Node.js version manager, built in Rust (2 days ago)
- [flox/flox-direnv](https://github.com/flox/flox-direnv) - direnv library for using Flox in your .envrc enabled projects (2 days ago)
- [bearstech/pussh](https://github.com/bearstech/pussh) - Parallel SSH, batch and command line oriented (4 days ago)
- [iterative/datachain](https://github.com/iterative/datachain) - ETL, Analytics, Versioning for Unstructured Data (4 days ago)
