...
- [vaadin/flow](https://github.com/vaadin/flow) ([24.5.0.alpha18](https://github.com/vaadin/flow/releases/tag/24.5.0.alpha18), 6 days ago) - Vaadin Flow is a Java framework binding Vaadin web components to Java. This is part of Vaadin 10&#43;.
...
- [fix: typo - preform -&gt; perform](https://github.com/edgedb/edgedb-java/pull/36) on [edgedb/edgedb-java](https://github.com/edgedb/edgedb-java) (5 days ago)
...
- [chaijs/chai](https://github.com/chaijs/chai) - BDD / TDD assertion framework for node.js and the browser that can be paired with any testing framework. (1 day ago)
- [briefercloud/briefer](https://github.com/briefercloud/briefer) - Dashboards and notebooks in a single place. Create powerful and flexible dashboards using code, or build beautiful Notion-like notebooks and share them with your team. (1 day ago)
...
- [tokio-rs/console](https://github.com/tokio-rs/console) - a debugger for async rust! (3 days ago)
- [igdmapps/igdm](https://github.com/igdmapps/igdm) - Desktop application for Instagram DMs (4 days ago)
- [JetBrains-Research/pubtrends](https://github.com/JetBrains-Research/pubtrends) - Scientific literature explorer. Runs a Pubmed or Semantic Scholar search and allows user to explore high-level structure of result papers (4 days ago)
- [uutils/findutils](https://github.com/uutils/findutils) - Rust implementation of findutils (6 days ago)
