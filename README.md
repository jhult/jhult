...
- [netbirdio/netbird](https://github.com/netbirdio/netbird) ([v0.16.0](https://github.com/netbirdio/netbird/releases/tag/v0.16.0), 3 days ago) - Connect your devices into a single secure private WireGuard®-based mesh network with SSO/MFA and simple access controls.
...
- [tellerops/teller](https://github.com/tellerops/teller) - Cloud native secrets management for developers - never leave your command line for secrets. (3 days ago)
...
- [bersler/OpenLogReplicator](https://github.com/bersler/OpenLogReplicator) - Open Source Oracle database CDC (5 days ago)
- [vippsas/zeroeventhub](https://github.com/vippsas/zeroeventhub) -  (6 days ago)
- [maxpert/marmot](https://github.com/maxpert/marmot) - A distributed SQLite replicator built on top of NATS (6 days ago)
