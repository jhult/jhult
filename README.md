...
- [aquaproj/aqua-registry](https://github.com/aquaproj/aqua-registry) ([v4.530.0](https://github.com/aquaproj/aqua-registry/releases/tag/v4.530.0), 1 day ago) - aqua&#39;s Standard Registry
- [Kuberwastaken/claurst](https://github.com/Kuberwastaken/claurst) ([v0.1.6](https://github.com/Kuberwastaken/claurst/releases/tag/v0.1.6), 4 days ago) - Agentic Coding for Builders who Ship
- [gastownhall/beads](https://github.com/gastownhall/beads) ([v1.1.0-rc.1](https://github.com/gastownhall/beads/releases/tag/v1.1.0-rc.1), 4 days ago) - Beads - A memory upgrade for your coding agent
- [aaif-goose/goose](https://github.com/aaif-goose/goose) ([v1.39.0](https://github.com/aaif-goose/goose/releases/tag/v1.39.0), 5 days ago) - an open source, extensible AI agent that goes beyond code suggestions - install, execute, edit, and test with any LLM
- [jdx/mise](https://github.com/jdx/mise) ([v2026.6.14](https://github.com/jdx/mise/releases/tag/v2026.6.14), 5 days ago) - dev tools, env vars, task runner
...
- [fix(link): use overwrite=true in upgrade/reinstall and surface conflicts](https://github.com/neul-labs/stout/pull/26) on [neul-labs/stout](https://github.com/neul-labs/stout) (1 day ago)
- [fix(doggo): use github backend for v1.2.0 asset naming](https://github.com/jdx/mise/pull/10601) on [jdx/mise](https://github.com/jdx/mise) (6 days ago)
- [fix(mr-karan/doggo): add version override for v1.2.0 asset naming change](https://github.com/aquaproj/aqua-registry/pull/55890) on [aquaproj/aqua-registry](https://github.com/aquaproj/aqua-registry) (6 days ago)
- [fix(aqua): support doggo v1.2.0 asset naming in vendored registry](https://github.com/jdx/mise/pull/10600) on [jdx/mise](https://github.com/jdx/mise) (6 days ago)
...
- [srothgan/claude-code-rust](https://github.com/srothgan/claude-code-rust) - A native Rust terminal interface for Claude Code (2 days ago)
- [nearai/ironclaw](https://github.com/nearai/ironclaw) - IronClaw is an Agent OS focused on privacy, security and extensibility (2 days ago)
...
- [harbor-framework/terminal-bench](https://github.com/harbor-framework/terminal-bench) - A benchmark for LLMs on complicated tasks in the terminal (2 days ago)
- [browser-use/terminal](https://github.com/browser-use/terminal) - Terminal UI to get stuff done in the browser (2 days ago)
- [microsoft/go-sqlcmd](https://github.com/microsoft/go-sqlcmd) - The new sqlcmd, CLI for SQL Server and Azure SQL (winget install sqlcmd / sqlcmd create mssql / sqlcmd open ads) (4 days ago)
- [buildbarn/bb-storage](https://github.com/buildbarn/bb-storage) - Storage daemon, capable of storing data for the Remote Execution protocol (5 days ago)
- [buildbarn/bonanza](https://github.com/buildbarn/bonanza) - An experimental Bazel compatible remote build system (5 days ago)
- [aquaproj/aqua-registry](https://github.com/aquaproj/aqua-registry) - aqua&#39;s Standard Registry (6 days ago)
- [jms830/wezterm-settings-gui](https://github.com/jms830/wezterm-settings-gui) - A visual configuration editor for WezTerm terminal emulator (6 days ago)
