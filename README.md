...
- [netbirdio/netbird](https://github.com/netbirdio/netbird) ([v0.23.4](https://github.com/netbirdio/netbird/releases/tag/v0.23.4), today) - Connect your devices into a single secure private WireGuard®-based mesh network with SSO/MFA and simple access controls.
