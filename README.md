...
- [aquasecurity/tfsec](https://github.com/aquasecurity/tfsec) ([v1.22.0](https://github.com/aquasecurity/tfsec/releases/tag/v1.22.0), 2 days ago) - Security scanner for your Terraform code
- [oracle/oci-python-sdk](https://github.com/oracle/oci-python-sdk) ([v2.70.0](https://github.com/oracle/oci-python-sdk/releases/tag/v2.70.0), 3 days ago) - Oracle Cloud Infrastructure SDK for Python
- [postalsys/emailengine](https://github.com/postalsys/emailengine) ([v2.21.1](https://github.com/postalsys/emailengine/releases/tag/v2.21.1), 4 days ago) - Headless email client
...
- [JLLeitschuh/ktlint-gradle](https://github.com/JLLeitschuh/ktlint-gradle) - A ktlint gradle plugin (1 day ago)
- [VSCodium/vscodium](https://github.com/VSCodium/vscodium) - binary releases of VS Code without MS branding/telemetry/licensing (1 day ago)
- [leangen/graphql-spqr](https://github.com/leangen/graphql-spqr) - Build a GraphQL service in seconds (1 day ago)
- [apache/thrift](https://github.com/apache/thrift) - Apache Thrift (1 day ago)
- [lukin/keywind](https://github.com/lukin/keywind) - Keywind is a component-based Keycloak Login Theme built with Tailwind CSS (1 day ago)
...
- [wundergraph/wundergraph](https://github.com/wundergraph/wundergraph) - WunderGraph is the Next-Generation API Developer Platform. (1 day ago)
- [google/blockly](https://github.com/google/blockly) - The web-based visual programming editor. (5 days ago)
- [XAMPPRocky/octocrab](https://github.com/XAMPPRocky/octocrab) - A modern, extensible GitHub API Client for Rust. (5 days ago)
