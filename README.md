...
- [tailscale/tailscale](https://github.com/tailscale/tailscale) ([v1.22.1](https://github.com/tailscale/tailscale/releases/tag/v1.22.1), 3 days ago) - The easiest, most secure way to use WireGuard and 2FA.
- [aquasecurity/tfsec](https://github.com/aquasecurity/tfsec) ([v1.8.0](https://github.com/aquasecurity/tfsec/releases/tag/v1.8.0), 3 days ago) - Security scanner for your Terraform code
- [vaadin/flow](https://github.com/vaadin/flow) ([23.0.1](https://github.com/vaadin/flow/releases/tag/23.0.1), 3 days ago) - Flow is a Java framework binding Vaadin web components to Java. This is part of Vaadin 10&#43;.
- [oracle/oci-python-sdk](https://github.com/oracle/oci-python-sdk) ([v2.60.0](https://github.com/oracle/oci-python-sdk/releases/tag/v2.60.0), 4 days ago) - Oracle Cloud Infrastructure SDK for Python
- [jhaals/yopass](https://github.com/jhaals/yopass) ([11.4.2](https://github.com/jhaals/yopass/releases/tag/11.4.2), 5 days ago) - Secure sharing of secrets, passwords and files 
- [gantsign/ktlint-maven-plugin](https://github.com/gantsign/ktlint-maven-plugin) ([1.12.0](https://github.com/gantsign/ktlint-maven-plugin/releases/tag/1.12.0), 6 days ago) - Maven plugin for ktlint the Kotlin linter
...
- [crossplane/crossplane](https://github.com/crossplane/crossplane) - Your Universal Control Plane (2 days ago)
- [costela/wesher](https://github.com/costela/wesher) - wireguard overlay mesh network manager (5 days ago)
