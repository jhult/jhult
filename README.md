...
- [aquasecurity/tfsec](https://github.com/aquasecurity/tfsec) ([v1.4.1](https://github.com/aquasecurity/tfsec/releases/tag/v1.4.1), 2 days ago) - Security scanner for your Terraform code
...
- [mismaah/ocr-rest-service](https://github.com/mismaah/ocr-rest-service) - REST service which returns text from an image when the url for the image is provided. (3 days ago)
