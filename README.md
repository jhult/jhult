...
- [postalsys/emailengine](https://github.com/postalsys/emailengine) ([v2.14.0](https://github.com/postalsys/emailengine/releases/tag/v2.14.0), 5 days ago) - Headless email client
- [oracle/oci-python-sdk](https://github.com/oracle/oci-python-sdk) ([v2.59.0](https://github.com/oracle/oci-python-sdk/releases/tag/v2.59.0), 6 days ago) - Oracle Cloud Infrastructure SDK for Python
- [vaadin/flow](https://github.com/vaadin/flow) ([23.0.0](https://github.com/vaadin/flow/releases/tag/23.0.0), 6 days ago) - Flow is a Java framework binding Vaadin web components to Java. This is part of Vaadin 10&#43;.
...
- [A few misc fixes](https://github.com/postalsys/emailengine/pull/117) on [postalsys/emailengine](https://github.com/postalsys/emailengine) (6 days ago)
...
- [thamara/time-to-leave](https://github.com/thamara/time-to-leave) - Log work hours and get notified when it&#39;s time to leave the office and start to live. (4 days ago)
...
- [yangshun/tech-interview-handbook](https://github.com/yangshun/tech-interview-handbook) - 💯 Curated interview preparation materials for busy engineers (5 days ago)
- [agamm/awesome-developer-first](https://github.com/agamm/awesome-developer-first) - A curated list of awesome developer-first tools products. (5 days ago)
- [zeke/semantic-pull-requests](https://github.com/zeke/semantic-pull-requests) - :robot: Let the robots take care of the semantic versioning (6 days ago)
