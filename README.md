...
- [vaadin/flow](https://github.com/vaadin/flow) ([24.5.0.beta4](https://github.com/vaadin/flow/releases/tag/24.5.0.beta4), 2 days ago) - Vaadin Flow is a Java framework binding Vaadin web components to Java. This is part of Vaadin 10&#43;.
- [kotest/kotest](https://github.com/kotest/kotest) ([v6.0.0.M1](https://github.com/kotest/kotest/releases/tag/v6.0.0.M1), 4 days ago) - Powerful, elegant and flexible test framework for Kotlin with assertions, property testing and data driven tests.
...
- [Expensify/Bedrock](https://github.com/Expensify/Bedrock) - Rock solid distributed database specializing in active/active automatic failover and WAN replication (3 days ago)
- [nhh/zero](https://github.com/nhh/zero) - Experimental jsxdom (3 days ago)
- [Hexastack/Hexabot](https://github.com/Hexastack/Hexabot) - Hexabot is an open-source AI chatbot / agent builder. I allows you to create and manage multi-channel and multilingual chatbots / agents with ease.  (3 days ago)
- [evoluhq/evolu](https://github.com/evoluhq/evolu) - A local-first platform designed for privacy, ease of use, and no vendor lock-in (3 days ago)
- [0xType/0xProto](https://github.com/0xType/0xProto) - A programming font focused on source code legibility (3 days ago)
...
- [yellow-footed-honeyguide/facad](https://github.com/yellow-footed-honeyguide/facad) - A modern, colorful directory listing tool for the command line 🗃️ (4 days ago)
...
- [aviator-co/av](https://github.com/aviator-co/av) - A command line tool to manage stacked PRs with Aviator (6 days ago)
