...
- [netbirdio/netbird](https://github.com/netbirdio/netbird) ([v0.16.0](https://github.com/netbirdio/netbird/releases/tag/v0.16.0), today) - Connect your devices into a single secure private WireGuard®-based mesh network with SSO/MFA and simple access controls.
...
- [tellerops/teller](https://github.com/tellerops/teller) - Cloud native secrets management for developers - never leave your command line for secrets. (today)
...
- [bersler/OpenLogReplicator](https://github.com/bersler/OpenLogReplicator) - Open Source Oracle database CDC (2 days ago)
- [vippsas/zeroeventhub](https://github.com/vippsas/zeroeventhub) -  (3 days ago)
- [maxpert/marmot](https://github.com/maxpert/marmot) - A distributed SQLite replicator built on top of NATS (3 days ago)
- [sksamuel/aedile](https://github.com/sksamuel/aedile) - Kotlin Wrapper for Caffeine (5 days ago)
- [apptainer/apptainer](https://github.com/apptainer/apptainer) - Apptainer: Application containers for Linux (6 days ago)
