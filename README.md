...
- [vaadin/flow](https://github.com/vaadin/flow) ([24.4.7](https://github.com/vaadin/flow/releases/tag/24.4.7), 2 days ago) - Vaadin Flow is a Java framework binding Vaadin web components to Java. This is part of Vaadin 10&#43;.
...
- [jrz/container-shell](https://github.com/jrz/container-shell) - Starts and attaches a sandboxed shell using docker with access to the current or project directory (1 day ago)
- [SINTEF/sourcegraph](https://github.com/SINTEF/sourcegraph) - Code Intelligence Platform (2 days ago)
- [classvsoftware/under-new-management](https://github.com/classvsoftware/under-new-management) - Detect when your installed extensions have changed owners. (2 days ago)
- [chdsbd/kodiak](https://github.com/chdsbd/kodiak) - 🔮 A bot to automatically update and merge GitHub PRs (2 days ago)
...
- [Paradoxis/Flask-Unsign](https://github.com/Paradoxis/Flask-Unsign) - Command line tool to fetch, decode, brute-force and craft session cookies of a  Flask  application by guessing secret keys. (4 days ago)
- [buildkite/terminal-to-html](https://github.com/buildkite/terminal-to-html) - Converts arbitrary shell output (with ANSI) into beautifully rendered HTML (5 days ago)
- [buildkite/migration](https://github.com/buildkite/migration) - [Alpha Version] 🛠️ Based on Compat, a tool to transform pipelines from other CI providers to Buildkite (5 days ago)
- [sjpiper145/MakerSkillTree](https://github.com/sjpiper145/MakerSkillTree) - A repository of Maker Skill Trees and templates to make your own.   (6 days ago)
