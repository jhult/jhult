...
- [jdx/mise](https://github.com/jdx/mise) ([v2026.6.10](https://github.com/jdx/mise/releases/tag/v2026.6.10), 1 day ago) - dev tools, env vars, task runner
- [jdx/hk](https://github.com/jdx/hk) ([v1.48.0](https://github.com/jdx/hk/releases/tag/v1.48.0), 4 days ago) - git hooks and project lints
- [Kuberwastaken/claurst](https://github.com/Kuberwastaken/claurst) ([v0.1.5](https://github.com/Kuberwastaken/claurst/releases/tag/v0.1.5), 4 days ago) - Agentic Coding for Builders who Ship
- [SimonHalvdansson/Harmonic-HN](https://github.com/SimonHalvdansson/Harmonic-HN) ([v3.0.2](https://github.com/SimonHalvdansson/Harmonic-HN/releases/tag/v3.0.2), 5 days ago) - Modern Android client for Hacker News
...
- [fix(casks): show which app needs admin privileges and cache sudo for session](https://github.com/neul-labs/stout/pull/25) on [neul-labs/stout](https://github.com/neul-labs/stout) (1 day ago)
- [fix(update): skip re-downloading index when already up to date](https://github.com/neul-labs/stout/pull/24) on [neul-labs/stout](https://github.com/neul-labs/stout) (1 day ago)
- [fix: retry rename on Windows transient file locks during install](https://github.com/jdx/mise/pull/10300) on [jdx/mise](https://github.com/jdx/mise) (4 days ago)
...
- [ubugeeei-prod/vize](https://github.com/ubugeeei-prod/vize) - Blazing fast Vue.js Toolchain. Compiler, Linter, Type Checker, Formatter, LSP, Story System, Editor Extensions. This already passed 7000&#43; test suites, includes real world E2E. (1 day ago)
- [torbiak/git-autofixup](https://github.com/torbiak/git-autofixup) - create fixup commits for topic branches (1 day ago)
- [yusufkaraaslan/Skill_Seekers](https://github.com/yusufkaraaslan/Skill_Seekers) - Convert documentation websites, GitHub repositories, and PDFs into Claude AI skills with automatic conflict detection (2 days ago)
- [trailofbits/claude-code-config](https://github.com/trailofbits/claude-code-config) - Opinionated defaults, documentation, and workflows for Claude Code at Trail of Bits (2 days ago)
...
- [jthack/ffuf_claude_skill](https://github.com/jthack/ffuf_claude_skill) - This is a &#34;skill&#34; for claude to use FFUF. (2 days ago)
- [obra/superpowers-lab](https://github.com/obra/superpowers-lab) - Experimental skills for Claude Code Superpowers - new techniques and tools (2 days ago)
- [dockur/windows-arm](https://github.com/dockur/windows-arm) - Windows for ARM in a Docker container. (2 days ago)
