...
- [neul-labs/grite](https://github.com/neul-labs/grite) - The issue tracker that lives in your repo. Built for AI agents. Works for humans. (3 months ago)

#### 🔭 Latest releases I've contributed to

- [tontinton/maki](https://github.com/tontinton/maki) ([v0.4.7](https://github.com/tontinton/maki/releases/tag/v0.4.7), 1 day ago) - An efficient AI coding agent extendable by neovim like Lua plugins
- [aaif-goose/goose](https://github.com/aaif-goose/goose) ([v1.46.0](https://github.com/aaif-goose/goose/releases/tag/v1.46.0), 1 day ago) - an open source, extensible AI agent that goes beyond code suggestions - install, execute, edit, and test with any LLM
- [jdx/mise](https://github.com/jdx/mise) ([v2026.8.5](https://github.com/jdx/mise/releases/tag/v2026.8.5), 1 day ago) - dev tools, env vars, task runner
- [aquaproj/aqua-registry](https://github.com/aquaproj/aqua-registry) ([v4.551.0](https://github.com/aquaproj/aqua-registry/releases/tag/v4.551.0), 1 day ago) - aqua&#39;s Standard Registry
- [jdx/hk](https://github.com/jdx/hk) ([v1.55.0](https://github.com/jdx/hk/releases/tag/v1.55.0), 2 days ago) - git hooks and project lints
- [gastownhall/beads](https://github.com/gastownhall/beads) ([v1.2.1](https://github.com/gastownhall/beads/releases/tag/v1.2.1), 2 days ago) - Beads - A memory upgrade for your coding agent
- [atuinsh/atuin](https://github.com/atuinsh/atuin) ([v18.20.0-beta.3](https://github.com/atuinsh/atuin/releases/tag/v18.20.0-beta.3), 6 days ago) - ✨ Making your shell magical
...
- [SimonHalvdansson/Harmonic-HN](https://github.com/SimonHalvdansson/Harmonic-HN) ([v3.1.2](https://github.com/SimonHalvdansson/Harmonic-HN/releases/tag/v3.1.2), 2 weeks ago) - Modern Android client for Hacker News
- [jsdom/jsdom](https://github.com/jsdom/jsdom) ([v30.0.1](https://github.com/jsdom/jsdom/releases/tag/v30.0.1), 2 weeks ago) - A JavaScript implementation of various web standards, for use with Node.js

#### 🔨 My recent Pull Requests

- [Add LICENSE](https://github.com/prime-radiant-inc/sprout/pull/4) on [prime-radiant-inc/sprout](https://github.com/prime-radiant-inc/sprout) (2 days ago)
- [release: 0.3.0](https://github.com/neul-labs/stout/pull/29) on [neul-labs/stout](https://github.com/neul-labs/stout) (4 days ago)
- [chore(CI): upgrade and pin CI actions](https://github.com/neul-labs/stout/pull/28) on [neul-labs/stout](https://github.com/neul-labs/stout) (4 days ago)
- [fix(state): fix root-owned state and installed files after sudo runs](https://github.com/neul-labs/stout/pull/27) on [neul-labs/stout](https://github.com/neul-labs/stout) (5 days ago)
...
- [MinishLab/semble](https://github.com/MinishLab/semble) - Fast and Accurate Code Search for Agents. Uses 99% fewer tokens than grep&#43;read (2 days ago)
- [prime-radiant-inc/obol](https://github.com/prime-radiant-inc/obol) - Read an AI-agent transcript and estimate what it cost — a Rust core with C-ABI bindings for Python, Go, and TypeScript (Bun &#43; Node). (2 days ago)
- [tontinton/miso](https://github.com/tontinton/miso) - A query engine over semi-structured logs (2 days ago)
- [tontinton/panther](https://github.com/tontinton/panther) - A shellcode compiler (2 days ago)
- [tontinton/dbeel](https://github.com/tontinton/dbeel) - A distributed thread-per-core document database (2 days ago)
- [OleksandrChekhovskyi/hax](https://github.com/OleksandrChekhovskyi/hax) - A minimalist, terminal-native coding agent written in C. (3 days ago)
...
- [zibo-chen/rust-paddle-ocr](https://github.com/zibo-chen/rust-paddle-ocr) - 高性能OCR识别库，支持上百种语言，提供命令行、图形界面及C API多种调用方式，使用便捷高效。  High-performance OCR library powered by PaddleOCR v4/v5/v6 with MNN backend. Supports 10&#43; languages (Chinese, English, Japanese, Korean, Arabic, Cyrillic, Thai, etc). Provides Rust crate &#43; C API &#43; CLI tools. Fast, lightweight, easy-to-integrate. (4 days ago)
