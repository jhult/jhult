...
- [vaadin/flow](https://github.com/vaadin/flow) ([24.5.0.alpha2](https://github.com/vaadin/flow/releases/tag/24.5.0.alpha2), 1 day ago) - Vaadin Flow is a Java framework binding Vaadin web components to Java. This is part of Vaadin 10&#43;.
- [kotest/kotest](https://github.com/kotest/kotest) ([v5.9.1](https://github.com/kotest/kotest/releases/tag/v5.9.1), 2 days ago) - Powerful, elegant and flexible test framework for Kotlin with additional assertions, property testing and data driven testing
- [http4k/http4k](https://github.com/http4k/http4k) ([5.22.0.0](https://github.com/http4k/http4k/releases/tag/5.22.0.0), 2 days ago) - The Functional toolkit for Kotlin HTTP applications. http4k provides a simple and uniform way to serve, consume, and test HTTP services.
...
- [fix(memo): don&#39;t panic on memo decoding](https://github.com/Granola-Team/mina-indexer/pull/1022) on [Granola-Team/mina-indexer](https://github.com/Granola-Team/mina-indexer) (5 days ago)
...
- [luke-clifton/shh](https://github.com/luke-clifton/shh) - Simple shell like scripting from Haskell (1 day ago)
- [risor-io/risor](https://github.com/risor-io/risor) - Fast and flexible scripting for Go developers and DevOps. (1 day ago)
- [tynanbe/rad](https://github.com/tynanbe/rad) - ✨ Run tasks in Gleam! (1 day ago)
- [gleam-lang/awesome-gleam](https://github.com/gleam-lang/awesome-gleam) - 💯 A collection of Gleam libraries, projects, and resources (1 day ago)
- [wojtekmach/req](https://github.com/wojtekmach/req) - Req is a batteries-included HTTP client for Elixir. (1 day ago)
- [Rucadi/nixsh](https://github.com/Rucadi/nixsh) - Nixsh is a simple shellscripting middleware that makes writing bash secure and *fun* (1 day ago)
- [koto-lang/koto](https://github.com/koto-lang/koto) - A simple, expressive, embeddable programming language, made with Rust (1 day ago)
- [dpc/redb-bincode](https://github.com/dpc/redb-bincode) - A wrapper around `redb` that makes it store everything as `bincode`d (3 days ago)
- [apache/opendal](https://github.com/apache/opendal) - Apache OpenDAL: access data freely. (3 days ago)
- [timeseries/qstudio](https://github.com/timeseries/qstudio) - qStudio - Free SQL Analysis Tool (3 days ago)
