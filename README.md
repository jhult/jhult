...
- [aquaproj/aqua-registry](https://github.com/aquaproj/aqua-registry) ([v4.539.0](https://github.com/aquaproj/aqua-registry/releases/tag/v4.539.0), 2 days ago) - aqua&#39;s Standard Registry
- [hovancik/stretchly](https://github.com/hovancik/stretchly) ([v1.22.0](https://github.com/hovancik/stretchly/releases/tag/v1.22.0), 2 days ago) - The break time reminder app
- [jdx/mise](https://github.com/jdx/mise) ([v2026.7.7](https://github.com/jdx/mise/releases/tag/v2026.7.7), 4 days ago) - dev tools, env vars, task runner
- [atuinsh/atuin](https://github.com/atuinsh/atuin) ([v18.17.1](https://github.com/atuinsh/atuin/releases/tag/v18.17.1), 5 days ago) - ✨ Making your shell magical
- [jdx/hk](https://github.com/jdx/hk) ([v1.51.0](https://github.com/jdx/hk/releases/tag/v1.51.0), 5 days ago) - git hooks and project lints
- [aaif-goose/goose](https://github.com/aaif-goose/goose) ([v1.43.0](https://github.com/aaif-goose/goose/releases/tag/v1.43.0), 5 days ago) - an open source, extensible AI agent that goes beyond code suggestions - install, execute, edit, and test with any LLM
...
- [Add MIT license](https://github.com/AgentWorkforce/burn/pull/496) on [AgentWorkforce/burn](https://github.com/AgentWorkforce/burn) (1 week ago)
...
- [olup/open-jj](https://github.com/olup/open-jj) -  (2 days ago)
- [keanemind/jjk](https://github.com/keanemind/jjk) - Jujutsu (jj) VCS support for VS Code (2 days ago)
- [laulauland/jj-hunk](https://github.com/laulauland/jj-hunk) - Non-interactive hunk distribution in jj CLI (2 days ago)
- [google/or-tools](https://github.com/google/or-tools) - Google&#39;s Operations Research tools: (2 days ago)
- [parcel-bundler/parcel](https://github.com/parcel-bundler/parcel) - The zero configuration build tool for the web. 📦🚀 (2 days ago)
- [garrettmoss/restore-claude-history](https://github.com/garrettmoss/restore-claude-history) - Recover deleted Claude Code chats on macOS — and back them up so they don&#39;t disappear again (4 days ago)
- [ojura/claude-skills](https://github.com/ojura/claude-skills) - A collection of Claude Code skills. (4 days ago)
