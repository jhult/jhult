...
- [go-gitea/gitea](https://github.com/go-gitea/gitea) ([v1.16.3](https://github.com/go-gitea/gitea/releases/tag/v1.16.3), today) - Git with a cup of tea, painless self-hosted git service
- [aquasecurity/tfsec](https://github.com/aquasecurity/tfsec) ([v1.5.0](https://github.com/aquasecurity/tfsec/releases/tag/v1.5.0), 1 day ago) - Security scanner for your Terraform code
- [postalsys/emailengine](https://github.com/postalsys/emailengine) ([v2.14.0](https://github.com/postalsys/emailengine/releases/tag/v2.14.0), 1 day ago) - Headless email client
- [oracle/oci-python-sdk](https://github.com/oracle/oci-python-sdk) ([v2.59.0](https://github.com/oracle/oci-python-sdk/releases/tag/v2.59.0), 2 days ago) - Oracle Cloud Infrastructure SDK for Python
- [vaadin/flow](https://github.com/vaadin/flow) ([23.0.0](https://github.com/vaadin/flow/releases/tag/23.0.0), 2 days ago) - Flow is a Java framework binding Vaadin web components to Java. This is part of Vaadin 10&#43;.
...
- [A few misc fixes](https://github.com/postalsys/emailengine/pull/117) on [postalsys/emailengine](https://github.com/postalsys/emailengine) (2 days ago)
...
- [thamara/time-to-leave](https://github.com/thamara/time-to-leave) - Log work hours and get notified when it&#39;s time to leave the office and start to live. (today)
...
- [zeke/semantic-pull-requests](https://github.com/zeke/semantic-pull-requests) - :robot: Let the robots take care of the semantic versioning (2 days ago)
- [apache/dubbo](https://github.com/apache/dubbo) - Apache Dubbo is a high-performance, java based, open source RPC framework. (3 days ago)
- [gravitee-io/gravitee-api-management](https://github.com/gravitee-io/gravitee-api-management) - Gravitee.io - OpenSource API Management (3 days ago)
