...
- [jillesvangurp/es-kotlin-client](https://github.com/jillesvangurp/es-kotlin-client) - Kotlin client for Elasticsearch that adds kotlin DSLs, support for co-routines, and more to the official Java client. (5 days ago)
...
- [oracle/oci-python-sdk](https://github.com/oracle/oci-python-sdk) ([v2.57.0](https://github.com/oracle/oci-python-sdk/releases/tag/v2.57.0), 1 day ago) - Oracle Cloud Infrastructure SDK for Python
- [vaadin/flow](https://github.com/vaadin/flow) ([23.0.0.beta2](https://github.com/vaadin/flow/releases/tag/23.0.0.beta2), 5 days ago) - Flow is a Java framework binding Vaadin web components to Java. This is part of Vaadin 10&#43;.
- [aquasecurity/tfsec](https://github.com/aquasecurity/tfsec) ([v1.1.5](https://github.com/aquasecurity/tfsec/releases/tag/v1.1.5), 5 days ago) - Security scanner for your Terraform code
- [apache/superset](https://github.com/apache/superset) ([superset-helm-chart-0.5.8](https://github.com/apache/superset/releases/tag/superset-helm-chart-0.5.8), 6 days ago) - Apache Superset is a Data Visualization and Data Exploration Platform
...
- [Fix typos](https://github.com/postalsys/emailengine/pull/112) on [postalsys/emailengine](https://github.com/postalsys/emailengine) (5 days ago)
- [Add MIT license](https://github.com/jdevelop/otk2gcal/pull/1) on [jdevelop/otk2gcal](https://github.com/jdevelop/otk2gcal) (6 days ago)
- [Fix principals not including local part of an email](https://github.com/smallstep/cli/pull/635) on [smallstep/cli](https://github.com/smallstep/cli) (6 days ago)
...
- [nguyenq/tess4j](https://github.com/nguyenq/tess4j) - Java JNA wrapper for Tesseract OCR API (1 day ago)
...
- [warren-bank/fork-crx-PrivacyPass-challenge-bypass](https://github.com/warren-bank/fork-crx-PrivacyPass-challenge-bypass) - Privacy Pass: a privacy-enhancing protocol and browser extension. (4 days ago)
- [tleyden/open-ocr](https://github.com/tleyden/open-ocr) - Run your own OCR-as-a-Service using Tesseract and Docker (4 days ago)
- [kba/awesome-ocr](https://github.com/kba/awesome-ocr) - Links to awesome OCR projects (4 days ago)
- [ElectricRCAircraftGuy/PDF2SearchablePDF](https://github.com/ElectricRCAircraftGuy/PDF2SearchablePDF) - `pdf2searchablepdf input.pdf` = voila! &#34;input_searchable.pdf&#34; is created &amp; now has searchable text! (4 days ago)
- [deajan/pmOCR](https://github.com/deajan/pmOCR) - A wrapper for tesseract / abbyyOCR11 ocr4linux finereader cli that can perform batch operations or monitor a directory and launch an OCR conversion on file activity (4 days ago)
- [tesseract4java/tesseract4java](https://github.com/tesseract4java/tesseract4java) - Java GUI and Tools for Tesseract OCR (4 days ago)
- [JonathanxD/meili-ktr](https://github.com/JonathanxD/meili-ktr) -  (5 days ago)
